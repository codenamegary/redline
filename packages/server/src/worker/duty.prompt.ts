...
import { Thread, ThreadMessage } from "@redline/http-contracts/artifact.models"
...
// Repo context is worker-only: the cwd rides in on the duty input. The
// contract is read-only — the duty's only output is the returned
